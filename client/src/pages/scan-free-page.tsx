...
export default function ScanFreePage() {
  ...
  return (
    <>
      <Helmet>
        <title>Free Security Scan | SecureScout</title>
      </Helmet>
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-10">
            ...
            <h1 className="text-3xl md:text-4xl font-bold mb-4">Free Website Security Scan</h1>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Get a quick overview of your website's security posture with our free scan tool.
          ...
          <div className="mt-16 bg-primary/30 border border-secondary/20 rounded-xl p-6 md:p-8">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="text-xl font-semibold mb-2">About our Free Security Scan</h3>
                <p className="text-muted-foreground mb-4">
                  Our free scan performs basic security checks on your website to identify common vulnerabilities.
