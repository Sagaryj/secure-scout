  ...
  const experts = [
    {
      ...
      experience:
        "Led security assessments for financial, healthcare, and government sectors.",
      specialties: [
    ...
    },
    {
      ...
      experience:
        "Discovered critical vulnerabilities in major e-commerce and banking applications.",
      specialties: [
    ...
    },
    {
      ...
      experience:
        "Designed secure network architectures for enterprise and cloud environments.",
      specialties: [
    ...
    },
    {
      ...
      experience:
        "Contributed to multiple CVEs and developed custom exploits for red team engagements.",
      specialties: [
        "Binary exploitation",
        "Reverse engineering",
        "Red team operations",
  ...
  const services = [
    {
      ...
      description:
        "Comprehensive security assessment of your web applications to identify and exploit vulnerabilities.",
      features: [
    ...
    },
    {
      ...
      description:
        "Thorough examination of your internal and external network infrastructure for security weaknesses.",
      features: [
    ...
    },
    {
      ...
      description:
        "Evaluate the security of your cloud infrastructure and identify risks in your deployment.",
      features: [
    ...
    },
    {
      ...
      description:
        "Simulate real-world targeted attacks to test your organization's detection and response capabilities.",
      features: [
    ...
    },
    {
      ...
      description:
        "Comprehensive security testing of your iOS and Android applications.",
      features: [
    ...
    },
    {
      ...
      description:
        "Build or enhance your organization's security program with expert guidance.",
      features: [
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Meet our team of professional security experts and learn about our advanced security testing services."
        />
      </Helmet>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-muted-foreground">
              Our security experts have helped organizations of all sizes
      ...
      <div id="services" className="bg-background py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-muted-foreground">
              Comprehensive security testing and consulting services tailored to
            ...
            <div className="flex flex-col lg:flex-row items-center gap-8">
              ...
              <div className="lg:w-2/3">
                ...
                <p className="text-muted-foreground mb-4">
                  Don't see exactly what you need? Our security experts can
                  create a custom assessment plan tailored to your unique
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              <div>
                ...
                <p className="text-muted-foreground mb-8">
                  Contact our security experts to discuss your security testing
                  needs or to schedule a consultation.
                </p>
                    ...
                    {messageSubmitted ? (
                      <div className="text-center py-8">
                        ...
                        <p className="text-muted-foreground mb-6">
                          We've received your message and a security expert will
                          contact you shortly.
                        </p>
                        <Button
                              ...
                              <FormItem>
                                ...
                                <FormControl>
                                  <Input
                                    ...
                                    {...field}
                                    className="bg-primary/30 border-secondary/30"
                                  />
                                </FormControl>
                                <FormMessage />
                              </FormItem>
              ...
              <TabsContent value="general" className="space-y-4">
                <Card className="border-secondary/20">
                  <CardContent className="pt-6">
                    <h3 className="text-lg font-medium mb-2">
                      What qualifications do your security experts have?
                    </h3>
                    <p className="text-muted-foreground text-sm">
                      Our security experts hold industry-recognized
                      certifications such as CISSP, OSCP, CEH, and SANS
                      certifications. They also have years of practical
                ...
                <Card className="border-secondary/20">
                  <CardContent className="pt-6">
                    ...
                    <p className="text-muted-foreground text-sm">
                      We follow strict confidentiality protocols and all our
                      engagements are covered by comprehensive NDAs. Our team
                      uses secure communication channels and encrypted storage
                      for all client data.
                    </p>
                  </CardContent>
                </Card>
                ...
                <Card className="border-secondary/20">
                  <CardContent className="pt-6">
                    ...
                    <p className="text-muted-foreground text-sm">
                      Yes, we offer emergency incident response services for
                      existing clients. Our team can quickly respond to security
                      incidents and provide guidance on containment,
              ...
              <TabsContent value="services" className="space-y-4">
                <Card className="border-secondary/20">
                  <CardContent className="pt-6">
                    ...
                    <p className="text-muted-foreground text-sm">
                      We can test a wide range of applications including web
                      applications, mobile apps (iOS and Android), APIs, desktop
                ...
                <Card className="border-secondary/20">
                  <CardContent className="pt-6">
                    <h3 className="text-lg font-medium mb-2">
                      Do you test internal networks or only external-facing
                      systems?
                    </h3>
                    <p className="text-muted-foreground text-sm">
                      We can test both internal networks and external-facing
                      systems. For internal network testing, we coordinate with
                      your team to establish secure access methods.
                    </p>
                  </CardContent>
                </Card>
                ...
                <Card className="border-secondary/20">
                  <CardContent className="pt-6">
                    <h3 className="text-lg font-medium mb-2">
                      What deliverables can we expect from a security
                      assessment?
                    </h3>
                    <p className="text-muted-foreground text-sm">
                      Our standard deliverables include a comprehensive report
                      with an executive summary, detailed technical findings,
                      severity ratings, proof-of-concept evidence, and
              ...
              <TabsContent value="engagement" className="space-y-4">
                <Card className="border-secondary/20">
                  <CardContent className="pt-6">
                    ...
                    <p className="text-muted-foreground text-sm">
                      The duration depends on the scope and complexity of the
                      assessment. A standard web application assessment
                      typically takes 1-2 weeks, while more comprehensive
                ...
                <Card className="border-secondary/20">
                  <CardContent className="pt-6">
                    <h3 className="text-lg font-medium mb-2">
                      What information do you need before starting an
                      assessment?
                    </h3>
                    <p className="text-muted-foreground text-sm">
                      We typically request information about the target systems,
                      network diagrams, IP ranges, user credentials (if
                      applicable), and points of contact for the engagement.
                    </p>
                  </CardContent>
                </Card>
                ...
                <Card className="border-secondary/20">
                  <CardContent className="pt-6">
                    ...
                    <p className="text-muted-foreground text-sm">
                      Yes, we offer post-assessment support to help your team
                      understand and address the findings. This can include
                      remediation guidance, verification testing, and developer
                      security training.
                    </p>
                  </CardContent>
                </Card>
